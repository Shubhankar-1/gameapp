...
public class RyuPlayer extends Player {
	...
	private void loadWalkImages() {
		walkImages[0] = image.getSubimage(60, 239, 77, 98);
		walkImages[1] = image.getSubimage(142, 239, 77, 98);
		walkImages[2] = image.getSubimage(225, 239, 60, 98);
		walkImages[3] = image.getSubimage(304, 239, 58, 98);
		walkImages[4] = image.getSubimage(377, 239, 59, 99);
